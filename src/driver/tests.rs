...
fn compile_fixtures_pipeline() {
    let files = [
        ...
        "examples/tests/ok_arc_basic.nia",
        "examples/tests/ok_mutex_basic.nia",
        ...
        "examples/sample_arc.nia",
        "examples/sample_threads_closure.nia",
        "examples/sample_mutex.nia",
        "examples/sample_rwlock.nia",
        "examples/sample_condvar.nia",
        ...
        "examples/sample_atomic_i128.nia",

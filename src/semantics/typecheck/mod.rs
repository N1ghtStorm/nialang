...
use crate::nia_std::{
    ...
    COS, DEALLOC, GATE_CNOT, GATE_CZ, GATE_H, GATE_R1, GATE_RX, GATE_RY, GATE_RZ, GATE_S,
    GATE_SWAP, GATE_T, GATE_X, GATE_Y, GATE_Z, LEN, LIST_CAPACITY, LIST_GET, LIST_LEN, LIST_NEW,
